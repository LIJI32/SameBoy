...
// Tweak these first
#define TILE_SCALE        4.0
#define VARIANTS          6.0
#define SEED              0.0

#define JITTER_LO         0.92
#define JITTER_HI         1.08

#define GRAIN_AMPL        0.10          // slightly reduced so bevel reads
#define BEVEL_STRENGTH    0.10          // BOOST to make it obvious (try 0.12)
